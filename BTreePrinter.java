...
class BTreePrinter {
    ...
    public static <T extends Comparable<?>> void printBinaryNode(BinaryNode root) {
        int maxLevel = BTreePrinter.maxLevel(root);

        printBinaryNodeInternal(Collections.singletonList(root), 1, maxLevel);
    }

    private static <T extends Comparable<?>> void printBinaryNodeInternal(List<BinaryNode> nodes, int level, int maxLevel) {
        ...
        List<BinaryNode> newBinaryNodes = new ArrayList<BinaryNode>();
